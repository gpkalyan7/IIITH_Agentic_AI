...
def cheap_disposition(msg: Message) -> tuple[str, str] | None:
    ...
    if not is_automated_sender(msg):
        return None
    # Subject first. A recognised noise subject settles it, whatever the body
    # says: a verification code that "expires in 10 minutes" is still a
    # verification code, and letting the body override here sent m066 down the
    # reasoning path to be escalated as if it were a contract.
